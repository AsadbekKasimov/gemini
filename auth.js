...
function confirmCheckout() {
    console.log('🎯 confirmCheckout() вызвана');
    ...
    // Сохраняем данные заказа глобально
    window.orderDataToSend = orderData;
    console.log('✅ Данные сохранены в window.orderDataToSend');
    ...
    console.log('✅ MainButton показана и активна');
    
    // Удаляем старые обработчики (если были)
    tg.MainButton.offClick();
    
    // Добавляем обработчик нажатия
    tg.MainButton.onClick(function sendOrder() {
        console.log('🚀 MainButton нажата! Отправка заказа...');
        console.log('📤 Отправляемые данные:', window.orderDataToSend);
        
        try {
            const dataString = JSON.stringify(window.orderDataToSend);
            console.log('📤 JSON строка:', dataString);
            ...
            console.log('✅ Заказ сохранён в localStorage');
    ...
    console.log('✅ Обработчик MainButton установлен');
